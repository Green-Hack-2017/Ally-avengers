...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="fn" name="fn" type="text" placeholder="first name" class="form-control input-md" value="emergency" readonly="readonly">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="ln" name="ln" type="text" placeholder="last name" class="form-control input-md" value="emergency" readonly="readonly">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="email" name="email" type="text" placeholder="email" class="form-control input-md" value="knidhan@hotmail.com" readonly="readonly">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="phone" name="phone" type="text" placeholder="Phone" class="form-control input-md" value="123456789" readonly="readonly">
